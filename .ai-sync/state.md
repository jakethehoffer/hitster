...
### 2026-07-31T02:27:49.9978434-04:00 - claude - handoff
...
### 2026-08-01T23:26:14.3349523-04:00 - claude - handoff
...
### 2026-08-02T00:39:45.9724144-04:00 - claude - handoff
...
### 2026-08-02T14:45:09.4946109-04:00 - claude - handoff
...
### 2026-08-02T14:58:09.8806117-04:00 - claude - handoff
...
### 2026-08-02T15:13:50.3414285-04:00 - claude - handoff
...
### 2026-08-02T19:15:08.0814282-04:00 - claude - handoff
...
### 2026-08-02T20:24:28.5678961-04:00 - codex - handoff
...
### 2026-08-02T21:25:12.0820647-04:00 - claude - handoff
...
### 2026-08-02T22:17:18.9477555-04:00 - claude - handoff
...
### 2026-08-02T23:23:51.6102434-04:00 - claude - handoff
...
### 2026-08-02T23:35:49.2465753-04:00 - claude - handoff
...
### 2026-08-02T23:56:36.9241315-04:00 - claude - handoff
...
### 2026-08-03T00:15:57.8470458-04:00 - claude - handoff
...
### 2026-08-03T02:11:19.9394103-04:00 - claude - handoff
...
### 2026-08-03T02:56:31.1012368-04:00 - claude - handoff
- summary: Three changes. (1) Dead timeline slots are gone. Nobody is ever dealt a year already on their timeline, so a slot between two consecutive years (2005-2006, 2011-2012) can never be filled by anything. New pure engine exports slotPossible/possibleSlots close it; placeCard and addChallenge now throw on such a slot; the timeline simply does not render it, so those cards sit flush. Safe by construction - a card that belongs between consecutive years cannot exist - and a test sweeps every year 1975-1996 against every hidden slot to prove no real draw ever needs one. (2) Settings screen on the home screen with a Visual effects choice: Full / Reduced / Off, persisted to hitster.fxLevel. stage-fx gained an FX_BUDGET table - Reduced drops the full-screen gradients, dance floor, ceiling beams and mirror-ball speckle, caps notes 140->28 and sparks 260->40, cuts the spawn rate and pins dpr to 1; Off is answered in app.js syncStageFx, which never attaches the canvas so no frame loop runs. (3) 'china' easter egg: red-and-gold room, 14 paper lanterns drifting up and lifting on the beat, gold caps and tassels. Remembered like dance and party. New test hook window.__hitster.render(). Commit 52963d5 on origin/master, live-verified.
- files changed: js/engine.js, js/app.js, js/stage-fx.js, css/style.css, index.html, test/engine.test.mjs, test/smoke.mjs, README.md
- tests run: npm test 127/127 passed (3 new engine tests: slotPossible boundaries incl. same-year pairs from steals, an exhaustive proof that no drawable year is ever correct in a hidden slot, and placeCard/addChallenge rejection); npm run smoke passed with 7 new steps - timeline shape asserted element by element as slot,1990,slot,2005,2006,slot,2011,2012,slot with 4 slots not 6; settings offers 3 levels, Reduced persists and sets fx-lean, Off detaches the canvas and hides it, the level survives a reload; china lights 14 lanterns and sets body.china, typing it again packs them away and clears the remembered flag. Frame cost measured under 20x CPU throttling with the canvas actually painting: Full 391ms median / Reduced 241ms / Off 6.1ms. Settings header geometry compared against the existing Decks header - identical (backRight 258, headLeft 277). Deployed site driven headlessly: all three confirmed, zero console errors.
- blockers: none
- next steps: Nothing outstanding. Notes: (1) the first frame-cost measurement was invalid - navigating to the home screen detached the canvas so all three levels read 6.1ms; the real measurement keeps an egg on so the canvas paints and throttles the CPU, since an unthrottled desktop hides the difference behind vsync. Re-measure the same way if the budget is ever retuned. (2) Reduced still runs the visualizer and equaliser on purpose - they are the parts tied to the music; if more speed is needed, thinning bands is the next lever. (3) china is deliberately a lantern festival rather than any caricature, matching the earlier crazy-mode decision.
